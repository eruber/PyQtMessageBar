...
sys.path.insert(1, os.path.abspath('../pyqtmessagebar'))
sys.setrecursionlimit(1500)


# -- Project information -----------------------------------------------------

project = 'PyQtMessageBar'
...
# We can mock the import of some modules to facilitate documentation builds
# since they are not necessary to build the documentation.
#autodoc_mock_imports = ['PyQt5', 'colour', 'pyqtlineeditprogressbar']
